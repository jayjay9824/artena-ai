...
function ArtImg({ url, title, artist, style: s }: { url: string | null; title: string; artist: string; style?: React.CSSProperties }) {
  ...
  if (url) return <img src={url} alt={title} style={{ objectFit: "cover", objectPosition: "top", display: "block", ...s }} />;
  return (
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        {listing.image_url ? (
          <img src={listing.image_url} alt={listing.title} style={{ width: "100%", aspectRatio: "4/5", objectFit: "cover", objectPosition: "top", display: "block" }} />
        ) : (
